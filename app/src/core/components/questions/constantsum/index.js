...
export default class ConstantSum extends React.Component {
  ...
  render() {
    ...
    const { setTotal, total, setValue, addOption, removeOption } = this.props.store;
      ...
      <div>
        ...
        <div>
          <p className={'question-type'}>
            Total &nbsp;
            <sup>
              *this will be the constant sum of below numeric value
            </sup>
          </p>
        </div>
        ...
        <input
          placeholder={'total'}
          onChange={setTotal.bind(this.props.store, this)}
          type={'number'}
          min={options.length}
          value={total}
          />
              ...
              <li
                ...
                <span>
                  ...
                  <input
                    ...
                    onChange={setValue.bind(this.props.store.store.model, index, this, total)}
                    />
